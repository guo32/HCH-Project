...
<div id="wrap">
	...
	<div id="wrap-content-bottom">			
		<table style="margin: 0 auto;" id="coffeeTable">	
					...
					<td style="/*padding: 10px;*/">
						<div class="box-content-1">
							<table>
								<tr>
									<td colspan="2">
										<a href="${pageContext.request.contextPath}/coffee/post?num=${coffee.num}"><img src="${pageContext.request.contextPath}/resources/image/${coffee.filename}" width="190px" height="185px"/></a>
									</td>
								</tr>
								<tr class="box-content-1-title">
									<td style="width: 90%;">
										...
										<br>
										<a href="${pageContext.request.contextPath}/coffee/post?num=${coffee.num}" class="text-ellipsis-title">${coffee.name}</a>
									</td>									
								</tr>
								<tr class="box-content-1-content">
									<td colspan="2">
										<a href="${pageContext.request.contextPath}/coffee/post?num=${coffee.num}" class="text-ellipsis" style="font-size: 80%;">게시자 | ${coffee.registrant} <br>게시일 | ${coffee.regdate}</a>
									</td>
								</tr>
								<tr>
									<td>
										<button type="button" onClick="location.href='/coffee/edit-coffee?num=${coffee.num}'" class="short-button-edit" style="margin-top: 5%;">수정</button>
										<button type="button" onClick="location.href='/coffee/delete-coffee?num=${coffee.num}'" class="short-button-delete" style="margin-top: 5%;">삭제</button>
									</td>
								</tr>
							</table>
						</div>					
