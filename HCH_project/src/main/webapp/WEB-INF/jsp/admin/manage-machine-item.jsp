...
<link href="${pageContext.request.contextPath}/resources/image/machine-bean.png" rel="shortcut icon" type="image/x-icon">
<style>
...
<div id="wrap">
	...
	<div id="wrap-content-bottom">
		<!-- 가전 -->
		<table style="margin: 0 auto;" id="machineTable">	
					...
					<td style="/*padding: 10px;*/">
						<div class="box-content-1">
							<table>
								<tr>
									<td colspan="2">
										<a href="${pageContext.request.contextPath}/machine/post?id=${machine.id}"><img src="${pageContext.request.contextPath}/resources/image/${machine.filename}" width="190px" height="185px"/></a>
									</td>
								</tr>
								<tr class="box-content-1-title">
									<td style="width: 90%;">
										...
										<br>
										<a href="${pageContext.request.contextPath}/machine/post?id=${machine.id}" class="text-ellipsis-title">${machine.name}</a>
									</td>									
								</tr>
								<tr class="box-content-1-content">
									<td colspan="2">
										<a href="${pageContext.request.contextPath}/machine/post?id=${machine.id}" class="text-ellipsis" style="font-size: 80%;">게시자 | ${machine.registrant} <br>게시일 | ${machine.regdate}</a>
									</td>
								</tr>
								<tr>
									<td>
										<button type="button" onClick="location.href='/machine/edit-machine?id=${machine.id}'" class="short-button-edit" style="margin-top: 5%;">수정</button>
										<button type="button" onClick="location.href='/machine/delete-machine?id=${machine.id}'" class="short-button-delete" style="margin-top: 5%;">삭제</button>
									</td>
								</tr>
							</table>
						</div>					
