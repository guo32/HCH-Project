		...
		<table class="post-content-1">			
			...
			<tr>
				...
				<td>
					<table>
						<tr>
							<td class="post-content-1-title">${coffee.name}</td>
							<td>
								...
								<c:if test="${member!=null}">
									<c:choose>
										<c:when test="${favorite==true}">
											<form action="release-favorite?num=${coffee.num}" method="post">
										...
										<c:otherwise>
											<form action="add-favorite?num=${coffee.num}" method="post">
